...
public class TrainingManager : MonoBehaviour {
    ...
    public void putCreaturesInScene()
    {
        ...
        {
            creaturesArray[i] = ((GameObject)Instantiate(creaturePrefab, new Vector3(UnityEngine.Random.Range(-50f, 50f), -1, UnityEngine.Random.Range(-50f, 50f)), creaturePrefab.transform.rotation)).GetComponent<Creature>();
